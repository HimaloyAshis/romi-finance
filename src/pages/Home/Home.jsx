...
const Home = () => {
    return (
        <div className='bg-[#0F0F0F] shadow-inner p-6 '>
            ...
            <div className='text-white gap-3  grid md:grid-cols-3 lg:grid-cols-3 mt-3'>
                <div className='w-3/3 border border-gray-200 rounded-md shadow-md flex gap-8 items-center px-4 py-5'>
                    <p>oklk</p>
                    <div>
                        <p >okok</p>
                        <p >$0</p>
